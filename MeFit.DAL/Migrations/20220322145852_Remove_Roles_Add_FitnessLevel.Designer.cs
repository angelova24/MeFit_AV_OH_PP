...
namespace MeFit.DAL.Migrations
{
    ...
    [Migration("20220322145852_Remove_Roles_Add_FitnessLevel")]
    partial class Remove_Roles_Add_FitnessLevel
    {
            ...
            modelBuilder.Entity("MeFit.DAL.Models.Domain.Profile", b =>
                {
                    ...
                    b.Property<int>("FintessLevelEvaluation")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MeFit.DAL.Models.Domain.User", b =>
                {
                    b.HasOne("MeFit.DAL.Models.Domain.Profile", "Profile")
                        .WithOne("User")
                        .HasForeignKey("MeFit.DAL.Models.Domain.User", "ProfileId");
